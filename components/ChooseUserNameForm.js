      ...
      <Box safeArea p="2" py="8" w="90%" maxW="290">
        ...
        <VStack space={3} mt="5">
          <FormControl>
            ...
            <TextInput  placeholder="Enter your username" style={{width:"100%"}}></TextInput>
            </View>
          </FormControl>


          <Button mt="2" colorScheme="indigo" style={{backgroundColor:"#267FFF"}} onPress={()=>navigation.navigate("AccountConfirmationScreen")}>
            Next
          </Button>
